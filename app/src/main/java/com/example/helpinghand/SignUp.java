...
import com.example.helpinghand.Class.newUser;
                ...
                if(task.isSuccessful()){
                    ...
                    crntuser.sendEmailVerification().addOnSuccessListener( new OnSuccessListener<Void>() {
                            ...
                            FirebaseDatabase.getInstance().getReference("Users").child( FirebaseAuth.getInstance().
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(SignUp.this, "Verification has sent", Toast.LENGTH_SHORT).show();
                                        mAuth.signOut();
                                        Intent intent = new Intent(SignUp.this, Sign_In.class);
                                        startActivity(intent);
                                        finish();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(SignUp.this, "Enter a correct email", Toast.LENGTH_SHORT).show();
